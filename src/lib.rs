...
const fn unwrap(value: Option<InstructionKind>) -> InstructionKind {
...
pub const fn decode_addsub_carry_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_addsub_carry(d))
}

pub const fn decode_addsub_ext_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_addsub_ext(d))
}

pub const fn decode_addsub_imm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_addsub_imm(d))
}

pub const fn decode_addsub_shift_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_addsub_shift(d))
}

pub const fn decode_asimdall_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdall(d))
}

pub const fn decode_asimddiff_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimddiff(d))
}

pub const fn decode_asimdelem_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdelem(d))
}

pub const fn decode_asimdext_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdext(d))
}

pub const fn decode_asimdimm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdimm(d))
}

pub const fn decode_asimdins_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdins(d))
}

pub const fn decode_asimdmisc_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdmisc(d))
}

pub const fn decode_asimdmiscfp16_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdmiscfp16(d))
}

pub const fn decode_asimdperm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdperm(d))
}

pub const fn decode_asimdsame_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdsame(d))
}

pub const fn decode_asimdsame2_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdsame2(d))
}

pub const fn decode_asimdsamefp16_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdsamefp16(d))
}

pub const fn decode_asimdshf_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdshf(d))
}

pub const fn decode_asimdtbl_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asimdtbl(d))
}

pub const fn decode_asisddiff_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisddiff(d))
}

pub const fn decode_asisdelem_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdelem(d))
}

pub const fn decode_asisdlse_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdlse(d))
}

pub const fn decode_asisdlsep_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdlsep(d))
}

pub const fn decode_asisdlso_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdlso(d))
}

pub const fn decode_asisdlsop_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdlsop(d))
}

pub const fn decode_asisdmisc_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdmisc(d))
}

pub const fn decode_asisdmiscfp16_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdmiscfp16(d))
}

pub const fn decode_asisdone_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdone(d))
}

pub const fn decode_asisdpair_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdpair(d))
}

pub const fn decode_asisdsame_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdsame(d))
}

pub const fn decode_asisdsame2_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdsame2(d))
}

pub const fn decode_asisdsamefp16_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdsamefp16(d))
}

pub const fn decode_asisdshf_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_asisdshf(d))
}

pub const fn decode_bitfield_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_bitfield(d))
}

pub const fn decode_branch_and_sys_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_branch_and_sys(d))
}

pub const fn decode_branch_imm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_branch_imm(d))
}

pub const fn decode_branch_reg_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_branch_reg(d))
}

pub const fn decode_compbranch_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_compbranch(d))
}

pub const fn decode_condbranch_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_condbranch(d))
}

pub const fn decode_condcmp_imm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_condcmp_imm(d))
}

pub const fn decode_condcmp_reg_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_condcmp_reg(d))
}

pub const fn decode_condsel_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_condsel(d))
}

pub const fn decode_crypto3_imm2_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_crypto3_imm2(d))
}

pub const fn decode_crypto3_imm6_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_crypto3_imm6(d))
}

pub const fn decode_crypto4_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_crypto4(d))
}

pub const fn decode_cryptoaes_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_cryptoaes(d))
}

pub const fn decode_cryptosha2_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_cryptosha2(d))
}

pub const fn decode_cryptosha3_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_cryptosha3(d))
}

pub const fn decode_cryptosha512_2_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_cryptosha512_2(d))
}

pub const fn decode_cryptosha512_3_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_cryptosha512_3(d))
}

pub const fn decode_dataproc_immediate_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_dataproc_immediate(d))
}

pub const fn decode_dataproc_register_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_dataproc_register(d))
}

pub const fn decode_dataproc_simd_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_dataproc_simd(d))
}

pub const fn decode_dp_1src_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_dp_1src(d))
}

pub const fn decode_dp_2src_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_dp_2src(d))
}

pub const fn decode_dp_3src_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_dp_3src(d))
}

pub const fn decode_exception_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_exception(d))
}

pub const fn decode_extract_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_extract(d))
}

pub const fn decode_float2fix_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_float2fix(d))
}

pub const fn decode_float2int_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_float2int(d))
}

pub const fn decode_floatccmp_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatccmp(d))
}

pub const fn decode_floatcmp_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatcmp(d))
}

pub const fn decode_floatdp1_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatdp1(d))
}

pub const fn decode_floatdp2_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatdp2(d))
}

pub const fn decode_floatdp3_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatdp3(d))
}

pub const fn decode_floatimm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatimm(d))
}

pub const fn decode_floatsel_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_floatsel(d))
}

pub const fn decode_ldst_immpost_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_immpost(d))
}

pub const fn decode_ldst_immpre_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_immpre(d))
}

pub const fn decode_ldst_pac_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_pac(d))
}

pub const fn decode_ldst_pos_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_pos(d))
}

pub const fn decode_ldst_regoff_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_regoff(d))
}

pub const fn decode_ldst_unpriv_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_unpriv(d))
}

pub const fn decode_ldst_unscaled_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldst_unscaled(d))
}

pub const fn decode_ldstexcl_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldstexcl(d))
}

pub const fn decode_ldstnapair_offs_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldstnapair_offs(d))
}

pub const fn decode_ldstpair_off_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldstpair_off(d))
}

pub const fn decode_ldstpair_post_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldstpair_post(d))
}

pub const fn decode_ldstpair_pre_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_ldstpair_pre(d))
}

pub const fn decode_load_and_store_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_load_and_store(d))
}

pub const fn decode_loadlit_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_loadlit(d))
}

pub const fn decode_log_imm_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_log_imm(d))
}

pub const fn decode_log_shift_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_log_shift(d))
}

pub const fn decode_memop_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_memop(d))
}

pub const fn decode_movewide_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_movewide(d))
}

pub const fn decode_pcreladdr_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_pcreladdr(d))
}

pub const fn decode_root_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_root(d))
}

pub const fn decode_system_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_system(d))
}

pub const fn decode_testbranch_unwrap(d: u32) -> InstructionKind {
    unwrap(decode_testbranch(d))
}
